package com.sonusourav.sadak.Account;
...
import com.sonusourav.sadak.activities.HomeActivity;
import com.sonusourav.sadak.R;
import com.sonusourav.sadak.User.RetrofitInterface;
import com.sonusourav.sadak.Utils.AppSingleton;
...
import com.sonusourav.sadak.Utils.VolleyErrorInstances;
  ...
  private void goToActivity(int activity) {
    ...
    switch (activity) {
      ...
      case 2:
        ...
        break;
      default:
        splashIntent = new Intent(SplashActivity.this, RegisterActivity.class);
        break;
    }
  }
